    ...
    blocks: [
      {
        ...
        body: "AI adoption works best when teams start from recurring knowledge workflows, define context boundaries, and scale only after measured pilot lift.",
        highlights: ["Workflow-first adoption", "Context contracts", "Measured pilot loops"],
      },
      {
        id: "roadmap",
        kind: "roadmap",
    ...
    blocks: [
      {
        ...
        kind: "summary",
        title: "Resource Map",
        body: "This carousel is best understood as a categorized toolkit: agent orchestration, retrieval systems, eval harnesses, and production observability.",
      },
      {
        id: "repositories",
        kind: "repos",
    ...
    blocks: [
      {
        ...
        body: "The carousel is an execution playbook: narrow the audience, sharpen the promise, run weekly distribution experiments, and review traction honestly.",
        highlights: ["Audience wedge", "Message-market fit", "Weekly traction review"],
      },
      {
        id: "execution-system",
        kind: "checklist",
    ...
    blocks: [
      {
        ...
        kind: "summary",
        title: "System Thesis",
        body: "Small daily changes compound when they are attached to identity, supported by environment design, and reviewed as part of a repeatable system.",
        highlights: ["Identity before outcomes", "Environment beats willpower", "Never miss twice"],
      },
      {
        id: "habit-system",
        kind: "checklist",
        title: "Habit Operating System",
        items: [
    ...
    blocks: [
      {
        ...
        body: "The path is not a reading list. It is a sequence of capability milestones: math intuition, model training, evaluation, deployment, and portfolio proof.",
      },
      {
        id: "learning-roadmap",
        kind: "roadmap",
